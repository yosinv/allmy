...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        if query_stat:
            ...
            splunkapp_upload_file_to_directory_bulk(datalake_service, file_system_name, target_filename,
                                                    splunkapp_data_path, datalake_directory, rows_count)
        else:
